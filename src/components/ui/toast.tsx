...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 pt-[max(16px,env(safe-area-inset-top))] pb-[max(16px,env(safe-area-inset-bottom))] sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col sm:pb-[max(16px,env(safe-area-inset-bottom))] md:max-w-[420px]",
      className
    )}
    {...props}
  />
